  ...
  >
                ...
                <div class="infoList">
                  ...
                  >
                    <template #item="{ element, index }">
                      <div class="des-container-item-product" v-if="index < 6">
            ...
            <div class="blockBox-item-box">
              <div class="squre-line">
                <div class="infoList_Drag">
                  ...
                  >
                    <template #item="{ element, index }">
                      <div class="des-container-item">
                        <gj-checkbox
                          v-model="element.isChebox"
                          class="checkbox-select"
                          @change="setCheboxFun(index)"
                        ></gj-checkbox>
                        <gj-image
                          width="120"
                          height="120"
    ...
    <template #footer>
      <gj-space>
        ...
        <gj-button shape="round" @click="editDraftConfirm">确定</gj-button>
      </gj-space>
    </template>
  </fullScreenDialog>
</template>
    ...
    watch(
      ...
      (newVal) => {
        if (newVal) {
          ...
          data.productImageslen = productImages.length;
          data.videoList = videoInfos;
          data.videoListlen = videoInfos.length;
          data.attributeList = variantAttr;
