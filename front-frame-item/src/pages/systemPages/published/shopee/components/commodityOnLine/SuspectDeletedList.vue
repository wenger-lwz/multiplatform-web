...
import AppTablePopover from "@pagesSystem/published/lazada/components/AppTablePopover.vue";
...
import { getListing, getListingVariantList } from "@/api/published/lazada";
import {
  titleListOpt2,
  useChangeList,
  specificationList,
  ...
  setup() {
    ...
    const getBtnList = () => {
      return [
        ...
        //   isPopConfirm: true,
        //   tooltipContent: "此商品将移至“已下架”选项卡，是否继续？",
        //   click: (row) => {
        //     // todo
        //     console.log(row);
        //   },
