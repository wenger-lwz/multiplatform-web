<template>
  <CommonPage
    currentRouterPermission="SHOPEE/pubShopeeOnLineGoods/view"
    :pageRest="true"
    ...
    <template #operate_bar-content>
      <OperateBar>
        <template #left>
          ...
          >
            <gj-button
              v-permissions="['Shopee/pubShopeeOnLineGoods/online/batchOff']"
              shape="round"
              type="primary"
              class="gray-border"
          ...
          >
            <gj-button
              v-permissions="['Shopee/pubShopeeOnLineGoods/online/batchSync']"
              shape="round"
              type="primary"
              class="gray-border"
          ...
          >
            <gj-button
              v-permissions="['Shopee/pubShopeeOnLineGoods/online/batchUpdate']"
              shape="round"
              type="primary"
              class="gray-border"
      ...
      return [
        {
          label: "编辑",
          outside: true,
          permission: ["Shopee/pubShopeeOnLineGoods/online/edit"],
          click: (row) => {
        ...
        {
          label: "复制",
          permission: ["Shopee/pubShopeeOnLineGoods/online/copy"],
          isPopConfirm: false,
          click: (row) => {
            data.onlineIds = row.id;
            data.actionType = 1;
        ...
        {
          label: "同步",
          permission: ["Shopee/pubShopeeOnLineGoods/online/sync"],
          isPopConfirm: false,
          click: (row) => {
            syncFn([row.id]);
          },
        ...
        {
          label: "更新",
          permission: ["Shopee/pubShopeeOnLineGoods/online/update"],
          isPopConfirm: false,
          click: (row) => {
            updateFn([row.id]);
          },
    ...
    const tableColumns = [
      ...
      },
      {
        ...
        customRender: ({ record }) => {
          return (
            <GbText>
              {emptyFilter(record.productType == 1 ? "普通商品" : "全球商品")}
            </GbText>
          );
        },
      },
