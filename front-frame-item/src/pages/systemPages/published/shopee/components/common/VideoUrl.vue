<template>
  <div class="">
    <!--  <div class="video-btn mb8">
      <gj-button type="text">Video URL</gj-button>
    </div> -->
    <div class="infoList">
      <div
        ...
        :key="index"
      >
        <gj-image width="120" :src="item.videoCoverUrl" :preview="false" />
        <div class="actions-wrap">
          <span class="actions">
            <span class="action preview-handle" v-if="item.resource">
              <SvgIcon
                svgClass="startVideo"
                :width="16"
  ...
  setup(props) {
    ...
    const setPageData = (respData) => {
      ...
      if (respData.video) {
        data[key].videoList[0] = {
          ...respData.video,
          thumbnailUrl: respData.video?.resource,
        };
      }
      saveStoreData();
    };
    ...
    const playVideo = (item) => {
      data.previewVideoUrl = item.resource;
